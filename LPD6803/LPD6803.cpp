 ...
 *
 * Library hacked for some faster block updates by tim@timtech.org for out
 * 2015 Hack the Perth Festival project - Theremin Bollards
 *****************************************************************************/
...
//--- [TG]
void LPD6803::clearPixels() {
    uint16_t data = 0x8000;
    pixels[0]= data;
    memcpy( ((char*)pixels)+sizeof(pixels[0]), pixels, sizeof(pixels)-sizeof(pixels[0]) );
